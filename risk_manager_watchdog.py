...
class RiskManagerWatchdog(BaseWatchdogV2):
    ...
    def __init__(
        ...
        *,
        ...
        th = RmThresholds(
            tick_warn_ms=bot_cfg.wd.rm_tick_warn_ms,
            tick_crit_ms=bot_cfg.wd.rm_tick_crit_ms,
            hb_warn_s=bot_cfg.wd.rm_hb_warn_s,
            hb_crit_s=bot_cfg.wd.rm_hb_crit_s,
            slip_age_warn_s=bot_cfg.wd.rm_slip_age_warn_s,
            slip_age_crit_s=bot_cfg.wd.rm_slip_age_crit_s,
            vol_age_warn_s=bot_cfg.wd.rm_vol_age_warn_s,
            vol_age_crit_s=bot_cfg.wd.rm_vol_age_crit_s,
            shadow_bias_warn_bps=bot_cfg.wd.rm_shadow_bias_warn_bps,
            shadow_bias_crit_bps=bot_cfg.wd.rm_shadow_bias_crit_bps,
            queuepos_warn_per_min=bot_cfg.wd.rm_queuepos_warn_per_min,
            queuepos_crit_per_min=bot_cfg.wd.rm_queuepos_crit_per_min,
            severe_warn_s=bot_cfg.wd.rm_severe_warn_s,
            severe_crit_s=bot_cfg.wd.rm_severe_crit_s,
            escalate_after_cycles=bot_cfg.wd.rm_escalate_after_cycles,
        )
        cfg = config or RiskManagerWatchdogConfig(check_interval=bot_cfg.wd.rm_interval_s, thresholds=th)
        super().__init__(
            name=name,
