...
class ReasonCodes:
    ...
    # Private WS (PWS_*)
    PWS_QUEUE_FULL_CRITICAL = "PWS_QUEUE_FULL_CRITICAL"
    PWS_QUEUE_FULL_OTHER = "PWS_QUEUE_FULL_OTHER"
    PWS_INVALID_FILL_CONTRACT = "PWS_INVALID_FILL_CONTRACT"
    PWS_UNSAFE_DEDUP = "PWS_UNSAFE_DEDUP"
    PWS_DEDUP_EXCEPTION = "PWS_DEDUP_EXCEPTION"
    PWS_DISPATCH_EXCEPTION = "PWS_DISPATCH_EXCEPTION"
    PWS_DRAIN_EXCEPTION = "PWS_DRAIN_EXCEPTION"
    PWS_QUEUE_EXCEPTION = "PWS_QUEUE_EXCEPTION"
    PWS_CALLBACK_NO_LOOP = "PWS_CALLBACK_NO_LOOP"
...
KNOWN_REASON_CODES = {
    ...
    # Private WS
    "PWS_QUEUE_FULL_CRITICAL", "PWS_QUEUE_FULL_OTHER", "PWS_INVALID_FILL_CONTRACT",
    "PWS_UNSAFE_DEDUP", "PWS_DEDUP_EXCEPTION", "PWS_DISPATCH_EXCEPTION", "PWS_DRAIN_EXCEPTION",
    "PWS_QUEUE_EXCEPTION", "PWS_CALLBACK_NO_LOOP",
    "RM_CAPS_INVALID",
